  ...
  if (quoteForm) {
    ...
    quoteForm.addEventListener("submit", (event) => {
      ...
      /* =====================================================
           ...
           Connect this section to your backend,
           Formspree, EmailJS, PHP, Firebase, etc.
           when you want real email submission.
           ===================================================== */
      ...
      setTimeout(() => {
        ...
        quoteForm.querySelectorAll('[aria-invalid="true"]').forEach((input) => {
          clearFieldError(input);
        });
